...
Xpertmud jest elastycznym klientem MUD. Wspiera takie języki skryptowe
jak perl, python oraz częściowo ruby. Posiada obsługę wielu okien
(które można do woli oskryptować!). Oczywiście można stosować
triggery, aliasy oraz jest możliwość zrobienia czego się tylko
zapragnie z wysyłanym do, bądź odbieranym z serwera mud tekstem. Poza
tym Xpertmud posiada stabilne oraz proste do poznania API do wtyczek.
Dzięki temu można poszerzyć jego możliwości pisząc dodatki oparte na
Qt.
...
wykorzystująca do tego (D)HTML oraz javascript.
